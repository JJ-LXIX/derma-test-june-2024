...
function ServiceSection({}: Props) {
  ...
  return (
    <div className="min-h-[150vh] w-full relative">
      ...
      {/* Services Table */}
      <div className="min-h-[150vh] w-full flex flex-col items-center">
            ...
            >
              ...
              <div className="w-full flex scale-x-100 transform duration-300 ease-in-out group-hover/service:scale-x-95">
                <div className="w-[10%] flex items-center justify-center">
                  <p className="text-2xl text-zinc-400">{service.index + 1}</p>
                </div>
                <div className=" h-full w-full flex items-center">
                  <p className="text-5xl text-zinc-800 font-semibold">
                    {service.service_name}
                  </p>
                </div>
              </div>
              <div className="w-fit text-nowrap flex -translate-x-10 opacity-0 items-center justify-center transform duration-300 ease-in-out group-hover/service:opacity-100 group-hover/service:translate-x-0">
