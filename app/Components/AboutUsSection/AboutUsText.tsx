...
function AboutUsText({ heading, para }: Props) {
  return (
    <div className="w-full min-h-[20rem]">
      <div className="w-full h-2/4 flex items-start overflow-hidden">
        <p className="text-[8rem] font-semibold text-zinc-900">
      ...
      <div className="w-full h-2/4">
        <motion.p
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="text-[3rem] font-light text-zinc-700"
        >
          {para}
        </motion.p>
      </div>
